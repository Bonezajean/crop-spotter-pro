...
const CropMonitoring = () => {
  ...
  const farmers: Farmer[] = [
    { id: "F-001", name: "Mugabo John", location: "Gatsibo, Eastern Province", fields: 3 },
    { id: "F-002", name: "Kamali Peace", location: "Bugesera, Eastern Province", fields: 2 },
    { id: "F-003", name: "Uwase Marie", location: "Nyagatare, Eastern Province", fields: 4 },
  ];
    ...
    { 
      ...
      render: (field: Field) => (
        <Button 
          size="sm" 
          variant="outline"
          onClick={() => navigate(`/assessor/crop-monitoring/${field.farmerId}/${field.id}`)}
        >
          View
        </Button>
      )
    ...
    return (
      <div className="p-8 space-y-6">
        ...
        <DataTable
          ...
          onRowClick={(farmer) => navigate(`/assessor/crop-monitoring/${farmer.id}`)}
        />
      </div>
    );
  }
  ...
  if (!fieldId) {
    return (
      <div className="p-8 space-y-6">
        <Button variant="ghost" onClick={() => navigate("/assessor/crop-monitoring")}>
        ...
        <div>
          ...
          <p className="text-muted-foreground">Select a field for crop monitoring</p>
        </div>
  ...
  return (
    <div className="p-8 space-y-6">
      <Button variant="ghost" onClick={() => navigate(`/assessor/crop-monitoring/${farmerId}`)}>
        <ArrowLeft className="h-4 w-4 mr-2" />
        Back to Field List
      </Button>
